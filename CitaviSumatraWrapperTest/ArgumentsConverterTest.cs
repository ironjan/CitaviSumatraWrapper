...
namespace CitaviSumatraWrapperTest
{
    ...
    public class ArgumentsConverterTest
    {
        ...
        [Test]
        [TestCase(new[] {"-page", "5", "\"C:\\some\\file.pdf\""}, "-page 5 \"C:\\some\\file.pdf\"")]
        [TestCase(new[] {"-page", "5", "-something", "else", "\"C:\\some\\file.pdf\""},
            "-page 5 -something else \"C:\\some\\file.pdf\"")]
        [TestCase(new[] {"-also", "\"in front\"", "-page", "5", "\"C:\\some\\file.pdf\""},
            "-also \"in front\" -page 5 \"C:\\some\\file.pdf\"")]
        [TestCase(new[] {"-before", "and", "-page", "5", "-also", "\"behind\"", "\"C:\\some\\file.pdf\""},
            "-before and -page 5 -also \"behind\" \"C:\\some\\file.pdf\"")]
